"""Bangun atau periksa receipt laboratorium optimisasi multiobjektif.
...
def _validate_verification_log(results_payload: bytes) -> None:
    ...
    check_line = (
        ...
        f"results_sha256={digest} plots=3 exercises=11 solver_calls=36"
    )
    required_counts = {
        check_line: 2,
        "unittest: 26 passed, 0 failed, 0 errors": 2,
        "visual_qa: 3 SVG diperiksa pada raster 1440x1020": 1,
        "manual_alignment: buku 13.10 tidak ada; manual 13.10 -> buku 13.11": 1,
        "source_defects_recorded: 3": 1,
...
def build_receipt() -> dict[str, Any]:
    ...
    return {
        ...
        "verification": {
            ...
            "manual_alignment": first_results["manual_alignment"],
            ...
            "source_defect_ids": [item["id"] for item in data["source_defects"]],
            "tests_failed_per_run": 0,
            "tests_passed_per_run": 26,
