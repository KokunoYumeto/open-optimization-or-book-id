"""Bangun atau periksa receipt laboratorium pemrograman bilangan bulat.
...
def _validate_verification_log(results_payload: bytes) -> None:
    ...
    check_line = (
        ...
        f"results_sha256={digest} plots=2 exercises=16 solver_calls=20 "
        "maximum_violation=0.0"
    )
    required_counts = {
        check_line: 2,
        "unittest: 32 passed, 0 failed, 0 errors": 2,
        "visual_qa: 2 SVG diperiksa pada raster selebar 1440 piksel": 1,
        "exercise_coverage: 16/16 terverifikasi": 1,
        "solver_terminations: 20 optimal per replay": 1,
        "maximum_solver_violation: 0": 1,
        "source_defects_recorded: 2": 1,
