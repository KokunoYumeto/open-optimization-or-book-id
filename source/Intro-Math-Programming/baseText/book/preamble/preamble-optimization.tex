...
\newcommand{\nphard}{\complexity{NP-sukar}}
\newcommand{\npcomplete}{\complexity{NP-lengkap}}
\newcommand{\polynomial}{{\color{ansi-green} \textit{Waktu polinomial (P)}}}
...
\newenvironment{exo}[1]%
{\refstepcounter{exo}%
  \protected@edef\@currentlabelname{Latihan \theexo: #1}% addition here
 \vspace{0.5cm}\noindent
 {\large\bfseries{Latihan \theexo~: #1} \par}
 {\par\vspace{0.5cm}}}
\makeatother
...
{\refstepcounter{codeCell}%
 \protected@edef\@currentlabelname{Kode}% addition here
{}
...
{\par\medskip
 ...
 \protected@edef\@currentlabelname{Contoh \theexo}% Update label for referencing
 \begin{framed}
 \begingroup\color{blue}%
 \textbf{Contoh \theexo: }\ignorespaces}
{\endgroup\end{framed}
 \medskip}
...
{\par\medskip
 ...
 \end{center}
 \color{black}%
 \textbf{Contoh \theexo: #1} % Include example number
...
{\par\medskip
 ...
 \textbf{Contoh \theexo: #1} % Include example number
 \hfill
 \ifstrempty{#2}{}{\protect\href{#2}{\ Excel \ }}%
 \ifstrempty{#3}{}{\protect\href{#3}{\ PuLP \ }}%
 \ifstrempty{#4}{}{\protect\href{#4}{\ Gurobipy \ }}% Code links
 \ignorespaces
 \par}
{\endgroup
 \end{framed}
