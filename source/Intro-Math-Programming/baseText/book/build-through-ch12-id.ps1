...
if ([string]::IsNullOrWhiteSpace($OutputDirectory)) {
    $OutputDirectory = Join-Path $laneRoot "output\through-ch12-pdf"
}
...
# single small figure at 600 dpi into the fixed lane-local TEXINPUTS shadow.
