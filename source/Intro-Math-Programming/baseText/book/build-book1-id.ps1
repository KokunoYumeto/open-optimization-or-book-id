...
if ([string]::IsNullOrWhiteSpace($OutputDirectory)) {
    $OutputDirectory = Join-Path $laneRoot "output\book1-pdf"
}
...
# Replace the one upstream Matplotlib PDF containing a Type 3 font with the
# deterministic font-safe replay already used by every admitted reader.
