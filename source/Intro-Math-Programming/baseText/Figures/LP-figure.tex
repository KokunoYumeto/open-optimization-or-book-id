...
\begin{tikzpicture}
    ...
    \draw[->, thick] 
        ...
        node[below right, font=\scriptsize] {Arah Fungsi Tujuan};

    % Add a label for the feasible region
    \node[blue!50!black, font=\small] at (2.25, 3.5) {Daerah Fisibel};

    % Add an arrow pointing to a vertex and label the vertex
    \draw[->, thick, blue] (4.5, 2.4) -- (3.9,2.4) 
        node[midway, below right, black, font=\scriptsize] {Titik Sudut};
